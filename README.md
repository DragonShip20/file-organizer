...
A simple cross-platform Python utility that helps sort files into categorised subfolders.
Minimal dependencies: only the standard Python library (os, shutil).
